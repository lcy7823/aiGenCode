package com.kaoyu.aicodebackend.langraph4j;
...
import com.kaoyu.aicodebackend.langraph4j.node.*;
...
public class CodeGenWorkflow {
        ...
        try {
            return new MessagesStateGraph<String>()
                    ...
                    .addConditionalEdges("code_quality_check",
                            ...
                            Map.of(
                                    "build", "project_builder",  //需要构建项目
                                    "skip_build", END,                  //不需要构建项目，直接跳过
                                    "fail", "code_generator"             //质检失败，重新生成代码
                            )
                    )
    ...
    private String routeBuildOrSkip(MessagesState<String> state) {
        ...
        if (generationType == CodeTypeEnum.HTML || generationType == CodeTypeEnum.MULTI_FILE) {
            return "skip_build";
        }
        // VUE_PROJECT 需要构建
        return "build";
