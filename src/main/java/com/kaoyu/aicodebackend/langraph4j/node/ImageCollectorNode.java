...
import com.kaoyu.aicodebackend.langraph4j.ai.ImageCollectionPlanService;
...
import com.kaoyu.aicodebackend.langraph4j.tool.ImageSearchTool;
import com.kaoyu.aicodebackend.langraph4j.tool.LogoGeneratorTool;
import com.kaoyu.aicodebackend.langraph4j.tool.MermaidDiagramTool;
import com.kaoyu.aicodebackend.langraph4j.tool.UndrawIllustrationTool;
...
public class ImageCollectorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            // 记录耗时
            watch.stop();
            log.info("图片收集耗时: {} 毫秒", watch.getTotalTimeMillis());
            // 更新状态
