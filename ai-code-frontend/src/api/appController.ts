...
export async function deleteAdminApp(body: API.DeleteRequest, options?: { [key: string]: any }) {
...
export async function getAdminAppVoById(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getAdminAppVoByIdParams,
...
/** 此处后端没有提供注释 POST /app/admin/list/vo/page */
export async function getAdminAppVoListPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVo>('/app/admin/list/vo/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /app/my/Vo/list/page */
export async function getMyAppVoListPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVo>('/app/my/Vo/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /app/sift/Vo/list/page */
export async function getSiftAppVoListPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVo>('/app/sift/Vo/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
